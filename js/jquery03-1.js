...
// parentsUntil() : 2개의 html 태그를 선택하고 2개의 태그 사이에 있는 조상태그를 선택
    ...
    // 후손 태그 선택
    // children() : 지정한 html 태그의 한단계 아래의 자손 태그들을 선택 
        // 형제 선택자 사용 시 자손 태그 중에서 하나를 선택하는 것도 가능함
    // find() : 지정한 html 태그의 모든 후손태그를 선택
    ...
    // nextUntil(): 지정한 태그의 다음 모든 형제 태그를 선택
    ...
    // });
    // siblings() 의 매개변수로 선택자 사용시 형제 태그들 중에서 매개변수로 지정한 태그만 선택됨
    $("#div06 > div > h2").siblings("p").css({
        "color" : "red",
        "border" : "solid 3px red" 
    });

    $("#div07 > div > h2").next().css({
        "color" : "red",
        "border" : "solid 3px red" 
    });
    ...
    $("#div10 > div > h6").prev().css({
        "color" : "red",
        "border" : "solid 3px red" 
    });
    $("#div11 > div > h5").prevAll().css({
        "color" : "red",
        "border" : "solid 3px red" 
    });
    $("#div12 > div > h6").prevUntil("#div09 > div > span").css({
        "color" : "red",
        "border" : "solid 3px red" 
    });
